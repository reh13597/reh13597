...
- Configured a CI/CD pipeline using **GitHub Actions** and **Vercel** to ensure bug-free code and smooth deployments of the website, boosting work productivity and efficiency
